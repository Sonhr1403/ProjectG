...
@ccclass
export default class SlotAstrosAutoSpin extends cc.Component {
  public static instance: SlotAstrosAutoSpin = null;
  ...
  protected onLoad(): void {
    SlotAstrosAutoSpin.instance = this;
    if (!SlotAstrosController.instance.isMobile) {
  ...
  private onStart() {
    SlotAstrosController.instance.runAutoSpin(parseInt(this.currentAutoNumber));
    this.onCancel();
  }
