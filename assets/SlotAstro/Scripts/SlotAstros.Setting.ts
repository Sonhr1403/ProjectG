...
import SlotAstrosMusicManager from "./SlotAstros.Music";

const { ccclass, property } = cc._decorator;
@ccclass
export default class SlotAstrosSetting extends cc.Component {
  public static instance: SlotAstrosSetting = null;
  ...
  async onLoad() {
    SlotAstrosSetting.instance = this;
  }
  ...
  private sliderVolumeCallback(slider: cc.Slider, customEventData: string) {
    ...
    SlotAstrosMusicManager.instance.setSystemVolume(this.volumeSlider.progress);
  ...
  private toggleMusic() {
    ...
    this.updateMusic();
    // SlotAstrosMusicManager.instance.setMusicStatus(this.musicEnabled);
  }
  ...
  private updateMusic() {
    if (this.musicEnabled === false) {
      ...
      SlotAstrosMusicManager.instance.setSystemVolume(0);
      // SlotAstrosMusicManager.instance.pauseSlotMusic();
    } else {
      ...
      SlotAstrosMusicManager.instance.setSystemVolume(this.volumeSlider.progress);
      // SlotAstrosMusicManager.instance.resumeSlotMusic();
    }
  }
