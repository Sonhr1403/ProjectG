  ...
  private updateSpine() {
    ...
    switch (this.stretching) {
      ...
      case StretchingType.VERTICAL:
        ...
        break;
      case StretchingType.FULL:
        cc.log(cc.view.getFrameSize().width / screenRatio / 1920,cc.view.getFrameSize().height / screenRatio / 1000)
        if (
          cc.view.getFrameSize().width / screenRatio / 1920 + 0.1 >
          cc.view.getFrameSize().height / screenRatio / 1000 + 0.1
        ) {
          this.node.scaleX =
            cc.view.getFrameSize().width / screenRatio / 1920 + 0.1;
          this.node.scaleY =
          ...
          this.node.scaleX =
            cc.view.getFrameSize().height / screenRatio / 1000 + 0.1;
          this.node.scaleY =
            cc.view.getFrameSize().height / screenRatio / 1000 +
            0.1;
        }
        // this.node.y = -cc.view.getFrameSize().height / screenRatio / 2;
        break;
