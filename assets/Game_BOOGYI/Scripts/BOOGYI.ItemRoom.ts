...
import BOOGYILobbyRoom from "./BOOGYI.LobbyRoom";

const { ccclass, property } = cc._decorator;
@ccclass
export default class BOOGYIItemRoom extends cc.Component {
    ...
    public renderRoom(roomInfo: any): void {
        ...
        if (playerMoney < this.roomInfo.maxJoin[0] || playerMoney > this.roomInfo.maxJoin[1]) {
            ...
            let strBg = "skm_room_" + this.roomInfo.bg;
            this.spBackground.spriteFrame = this.spBgAtlas.getSpriteFrame(strBg);
    ...
    public chooseRoom() {
        ...
        if (this.roomInfo.key) {
            ...
            BOOGYILobbyRoom.instance.sendJoinRoomType(this.roomInfo);
        }
    }
}
