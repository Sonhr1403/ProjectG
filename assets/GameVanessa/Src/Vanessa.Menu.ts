...
@ccclass
export default class VanessaMenu extends cc.Component {
  public static instance: VanessaMenu = null;
  @property(cc.Slider)
  ...
  private sliderVolumeCallback(slider: cc.Slider, customEventData: string) {
    ...
    VanessaSoundController.instance.setSystemVolume(this.volumeSlider.progress);
  }
  ...
  private toggleLanguageOptions() {
    ...
    for (let b = 0; b < this.languageOptions.children.length; b++) {
      ...
      if (b == VanessaMain.instance.languageIndex) {
  ...
  private changeLanguage(eventdata, idx) {
    ...
    for (let a = 0; a <= 1; a++) {
      VanessaMain.instance.textWaysTable[a].font =
        VanessaMain.instance.fontWaysTable[index];
    }
    ...
    VanessaMain.instance.languageIndex = idx;
    for (let i = 0; i <= 18; i++) {
      VanessaMain.instance.textInfo[i].font =
        VanessaMain.instance.fontInfo[idx];
    }
    for (let i = 0; i < 7; i++) {
      VanessaMain.instance.textTitle[i].font =
        VanessaMain.instance.fontTitle[idx];
    }
    for (let i = 0; i < 15; i++) {
      VanessaMain.instance.textInfoList[i].font =
        VanessaMain.instance.fontInfoList[idx];
    }
    for (let i = 0; i < 3; i++) {
      VanessaMain.instance.textFreespinBanner[i].font =
        VanessaMain.instance.fontFreespinBanner[idx];
      VanessaMain.instance.textSymbolTitle[i].font =
        VanessaMain.instance.fontSymbolTitle[idx];
      VanessaMain.instance.textTotalBet[i].font =
        VanessaMain.instance.fontTotalBet[idx];
    }
  }
  ...
  toggleMusic() {
    ...
    if (this.musicEnabled == true) {
      ...
      VanessaSoundController.instance.setSystemVolume(0);
    } else {
      ...
      VanessaSoundController.instance.setSystemVolume(
  ...
  toggleVibration() {
    ...
    if (this.vibrationEnabled == true) {
      ...
      VanessaMain.instance.vibrationEnabled = false;
    } else {
