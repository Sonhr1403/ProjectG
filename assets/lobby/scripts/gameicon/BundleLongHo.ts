...
@ccclass
export default class BundleLongHo extends BundleDownLoad {
    ...
    _onClicked() {
        BGUI.ZLog.log("BGUI.GameCoreManager.instance.isLoginSuccess ===============>" + BGUI.GameCoreManager.instance.isLoginSuccess);
        super._onClicked();
    }
