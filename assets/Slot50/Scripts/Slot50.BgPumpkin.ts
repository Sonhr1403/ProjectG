...
@ccclass
export default class Slot50BgPumpkin extends cc.Component {
    public static instance: Slot50BgPumpkin = null;
    ...
    public changeJackpot(data: Slot50Cmd.ImpItemJackpot): void {
    ...
    private setIndex(data: Slot50Cmd.ImpItemJackpot): number {
