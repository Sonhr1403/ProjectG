...
@ccclass
export default class SongKranSetting extends cc.Component {
  public static instance: SongKranSetting = null;
  ...
  private sliderVolumeCallback(slider: cc.Slider, customEventData: string) {
    ...
    SongKranMusicManager.instance.setSystemVolume(this.volumeSlider.progress);
  ...
  private toggleMusic() {
    ...
    this.updateMusic();
    SongKranMusicManager.instance.setMusicStatus(this.musicEnabled);
  }
  ...
  private updateMusic() {
    if (this.musicEnabled === false) {
      ...
      SongKranMusicManager.instance.setSystemVolume(0);
      SongKranMusicManager.instance.pauseSlotMusic();
    } else {
      ...
      SongKranMusicManager.instance.setSystemVolume(this.volumeSlider.progress);
      SongKranMusicManager.instance.resumeSlotMusic();
    }
  }
